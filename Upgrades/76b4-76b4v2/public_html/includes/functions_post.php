...
/*****************************************************/
	if($move_after_post == 1)
	{
		...
		$message = $lang['Stored'] . '<br />' . $cash_message . '<br /><br />' . sprintf($lang['Click_move_message'], '<a href="' . append_sid('modcp.' . $phpEx . '?mode=move&amp;' . POST_TOPIC_URL . '=' . $topic_id ) . '">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_forum'], '<a href="' . append_sid("viewforum.$phpEx?" . POST_FORUM_URL . "=$forum_id") . '">', '</a>');
		$SID = $OldSID;
