...
/*****************************************************/
        $strip_var_list = array('email' => 'email', 'icq' => 'icq', 'aim' => 'aim', 'msn' => 'msn', 'yim' => 'yim', 'website' => 'website', 'location' => 'location', 'occupation' => 'occupation', 'user_wordwrap' => 'user_wordwrap', 'interests' => 'interests', 'confirm_code' => 'confirm_code');
/*****************************************************/
...
/*****************************************************/
		$showquickreply = ( isset($HTTP_POST_VARS['showquickreply']) ) ? ( (intval($HTTP_POST_VARS['showquickreply'])) ? TRUE : 0 ) : $board_config['allow_quickreply'];
/*****************************************************/
...
/* Forum - QUICK REPLY 1.0.2                   START */
/*****************************************************/
		$showquickreply = ( isset($HTTP_POST_VARS['showquickreply']) ) ? ( (intval($HTTP_POST_VARS['showquickreply'])) ? TRUE : 0 ) : $userdata['user_quickreply'];
/*****************************************************/
/* Forum - QUICK REPLY 1.0.2                   END   */
/*****************************************************/
        }
...
/*****************************************************/
/* Forum - Common Replies v.1.0.4              START */
/*****************************************************/
...
/*****************************************************/
/* Forum - Common Replies v.1.0.4                END */
/*****************************************************/
//
...
/* Forum - Force Word Wrapping v.1.0.12        START */
/*****************************************************/
                        $sql = "INSERT INTO " . USERS_TABLE . "        (user_id, username, user_regdate, user_password, user_email, user_icq, user_website, user_occ, user_from, user_interests, user_avatar, user_avatar_type, user_viewemail, user_aim, user_yim, user_msnm, user_attachsig, user_allowsmile, user_allowhtml, user_allowbbcode, user_allow_viewonline, user_notify, user_notify_pm, user_popup_pm, user_timezone, user_dateformat, user_wordwrap, user_lang, user_style, user_level, user_allow_pm, user_active, user_actkey)
                                VALUES ('$user_id', '" . str_replace("\'", "''", $username) . "', '" . $reg_date . "', '" . str_replace("\'", "''", $new_password) . "', '" . str_replace("\'", "''", $email) . "', '" . str_replace("\'", "''", $icq) . "', '" . str_replace("\'", "''", $website) . "', '" . str_replace("\'", "''", $occupation) . "', '" . str_replace("\'", "''", $location) . "', '" . str_replace("\'", "''", $interests) . "', $avatar_sql, $viewemail, '" . str_replace("\'", "''", str_replace(' ', '+', $aim)) . "', '" . str_replace("\'", "''", $yim) . "', '" . str_replace("\'", "''", $msn) . "', '$attachsig', '$allowsmilies', '$allowhtml', '$allowbbcode', '$allowviewonline', '$notifyreply', '$notifypm', '$popup_pm', '$user_timezone', '" . str_replace("\'", "''", $user_dateformat) . "', '" . str_replace("\'", "''", $user_wordwrap) . "', '" . str_replace("\'", "''", $user_lang) . "', '$user_style', '1', '1', ";
/*****************************************************/
/* Forum - Force Word Wrapping v.1.0.12          END */
/*****************************************************/
