    ...
    <script> 
      ...
      function postToFeed() {
        ...
        var obj = {
          ...
          picture: '<?=$feedicon?>',
          name: 'The facebook SandBox Module - Coded for PHP-Nuke Platinum',
          caption: 'A place to practice with facebook\'s many Social Plugins',
          description: 'A Programming module written by: Ernest Buffington. This module only works with PHP-Nuke Platinum - If you would like to have a Blog portal that interacts with facebook and Google goto http://cvs.86it.us and create a user account using your first and last name. When you are done send a private message to Ernest Buffington. The Blog portals are free and come with a full blown commercial website running PHP-Nuke Platinum v1.0.1z'
        };
