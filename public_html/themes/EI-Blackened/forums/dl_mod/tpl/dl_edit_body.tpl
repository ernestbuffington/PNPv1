...
<tr>
	<th class="thTop" colspan="3">{L_DL_FILES_TITLE}</th>
</tr>
<!-- BEGIN upload_traffic -->
<tr>
	<td class="row3" colspan="3" align="center"><span class="gensmall"><b>{upload_traffic.L_DL_UPLOAD_TRAFFIC_COUNT}</b></span></td>
</tr>
<!-- END upload_traffic -->
<tr>
...
<tr><td colspan="2" hEI-Blackenedght="3" class="row3"></td></tr>
<tr>
	...
	<td class="row2" width="68%">
				...
				<span class="gensmall">{MAX_UPLOAD_SIZE}{L_EXT_BLACKLIST}</span></td>
</tr>
<tr>
	...
	<td class="row2" width="68%">
			...
			&nbsp;&nbsp;<input type="text" class="post" name="file_name" size="40" value="{URL}" /></td>
</tr>
<!-- BEGIN allow_thumbs -->
<tr><td colspan="3" hEI-Blackenedght="3" class="row3"></td></tr>
<tr>
