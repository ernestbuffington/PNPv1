...
<tr>
	<td align="left" class="nav"><a href="{U_INDEX}" class="nav">{L_INDEX}</a>&nbsp;&raquo;&nbsp;<a href="{U_DOWNLOADS}" class="nav">{L_DOWNLOADS}</a>&nbsp;&raquo;&nbsp;{L_CONFIGURATION_TITLE}</td>
</tr>
</table>
...
<tr>
	<th colspan="3" hEI-Blackenedght="25">{L_CONFIGURATION_TITLE}</th>
</tr>
...
<!-- BEGIN cash_title -->
<tr>
	<th colspan="3" hEI-Blackenedght="25">{cash_title.L_EXCHANGE_TITLE}</th>
</tr>
<!-- END cash_title -->
<!-- BEGIN exchange_row -->
<tr>
...
<!-- END exchange_row -->
<tr>
	<td class="catbottom" colspan="3" align="center">{S_HIDDEN_FIELDS}
...
<table width="100%" cellpadding="3" cellspacing="1" border="0" align="center" class="forumline">
<tr>
	<th width="90%" class="thCornerL">{fav_block.L_DOWNLOAD}</th>
	<th width="10%" class="thCornerR">{fav_block.L_DELETE}</th>
</tr>
<!-- BEGIN favorite_row -->
<tr>
...
<!-- END favorite_row -->
<tr>
	<td colspan="2" class="catbottom" align="right"><input type="submit" name="submit" value="{fav_block.L_DELETE}" class="mainoption" /></td>
</tr>
</table>
<table border="0" width="100%">
<tr>
	<td align="right" nowrap="nowrap">
		<a href="javascript:select_switch(true);" class="gensmall">{fav_block.L_MARK_ALL}</a> ::
		<a href="javascript:select_switch(false);" class="gensmall">{fav_block.L_UNMARK_ALL}</a>
	</td>
</tr>
</table>
