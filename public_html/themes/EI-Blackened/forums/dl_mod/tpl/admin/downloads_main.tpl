...
<tr>
	<td valign="top"><span class="genmed">{DL_MANAGEMENT_EXPLAIN}</span>
	...
	<td valign="top" align="right"><span class="mainmenu">
...
<tr>
	...
	<td align="center" width="{ROW_WIDTH}%" valign="top"><span class="gen">
