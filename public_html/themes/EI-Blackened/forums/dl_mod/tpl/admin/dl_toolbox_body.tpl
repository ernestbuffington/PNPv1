...
<tr>
	<th class="thHead" colspan="2">{L_DL_MANAGE}</th>
</tr>
<tr>
...
<table class="forumline" border="0" cellpadding="3" cellspacing="1" align="center" width="50%">
<tr>
	<td class="row3" colspan="4"><span class="nav">{DL_NAVI}</span></td>
</tr>
<!-- BEGIN dirs_row -->
<tr>
...
<!-- BEGIN empty_folder -->
<tr>
	<td class="row1" align="center" colspan="4"><span class="genmed">{empty_folder.L_NO_CONTENT}</span></td>
</tr>
<!-- END empty_folder -->
<!-- BEGIN overall_size -->
<tr>
	<td class="catbottom" width="75%" colspan="2"><span class="genmed">
				&nbsp;{overall_size.S_FILE_ACTION}&nbsp;<input type="submit" name="file_action" value="{L_GO}" /></span>
	</td>
	<td class="catbottom" width="20%" align="right"><span class="genmed"><b>{overall_size.OVERALL_SIZE}</b>&nbsp;</span></td>
	<td class="catbottom" width="5%"><span class="genmed">&nbsp;<b>{overall_size.OVERALL_SIZE_RANGE}</b></span></td>
</tr>
<!-- END overall_size -->
