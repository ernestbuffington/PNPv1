...
<tr>
	<td width="50%" valign="top">
		...
		<tr>
			<td class="row3" colspan="2" align="center"><span class="gensmall">{L_USER_EXPLAIN}</span></td>
		</tr>
		<tr>
			<td class="row1" width="25%"><span class="gen">{L_USERNAME}:</span></td>
			<td class="row2" width="75%"><input type="text" class="post" name="username" size="20" maxlength="32" value="" /></td>
		</tr>
		<tr>
			<td class="row1" width="25%"><span class="gen">{L_TRAFFIC}:</span></td>
		...
		<tr>
			<td class="row1" width="25%"><span class="gen">{L_FUNCTION}:</span></td>
		...
		<table width="100%" cellspacing="1" cellpadding="3" border="0" align="center" class="forumline">
		<tr>
			<th class="thHead" colspan="2" align="center">{L_ALL_USERS_TITLE}</th>
		</tr>
		<tr>
			<td class="row3" width="100%" colspan="2" align="center"><span class="gensmall">{L_ALL_USERS_EXPLAIN}</span></td>
		</tr>
		<tr>
			<td class="row1" width="25%"><span class="gen">{L_TRAFFIC}:</span></td>
			<td class="row2" width="75%"><span class="gen"><input type="text" class="post" name="all_traffic" size="20" maxlength="40" />&nbsp;
			...
			<input type="radio" name="y" value="gb"/>&nbsp;{L_DL_GB}</span></td>
		</tr>
		<tr>
			<td class="row1" width="25%"><span class="gen">{L_FUNCTION}:</span></td>
			<td class="row2" width="75%"><span class="gen"><input type="radio" name="func" value="add" checked="checked"/>&nbsp;{L_ADD}&nbsp;&nbsp;&nbsp;<input type="radio" name="func" value="set"/>&nbsp;{L_SET}</span></td>
		</tr>
		<tr>
			<td class="catBottom" colspan="2" align="center"><input type="submit" name="submit" value="{L_SUBMIT}" class="mainoption" />&nbsp;&nbsp;<input type="reset" value="{L_RESET}" class="liteoption" /></td>
		</tr>
		...
		<table width="100%" cellspacing="1" cellpadding="3" border="0" align="center" class="forumline">
		<tr>
			<th class="thHead" colspan="2">{L_USERGROUP_TITLE}</th>
		</tr>
		<tr>
			<td class="row3" colspan="2" align="center"><span class="gensmall">{L_USERGROUP_EXPLAIN}</span></td>
		</tr>
		<tr>
			<td class="row1" width="25%"><span class="gen">{L_USERGROUP}:</span></td>
			<td class="row2" width="75%">{S_GROUP_SELECT}</td>
		</tr>
		<tr>
			<td class="row1" width="25%"><span class="gen">{L_TRAFFIC}:</span></td>
			<td class="row2"><span class="gen"><input type="text" class="post" name="group_traffic" size="20" maxlength="40" />&nbsp;
			...
			<input type="radio" name="z" value="gb"/>&nbsp;{L_DL_GB}</span></td>
		</tr>
		<tr>
			<td class="row1" width="25%"><span class="gen">{L_FUNCTION}:</span></td>
			<td class="row2" width="75%"><span class="gen"><input type="radio" name="func" value="add" checked="checked"/>&nbsp;{L_ADD}&nbsp;&nbsp;&nbsp;<input type="radio" name="func" value="set"/>&nbsp;{L_SET}</span></td>
	...
	<td width="50%" valign="top">
		...
		<tr>
			<td class="row3" colspan="2" align="center"><span class="gensmall">{L_CONFIGURATION_EXPLAIN}</span></td>
		</tr>
		<tr>
			<th class="thHead" colspan="2">{L_USER_WITHOUT_GROUP}</th>
		</tr>
		<tr>
			<td class="row1" width="30%"><span class="gen">{L_USER_DL_AUTO_TRAFFIC}</span></td>
			<td class="row2" width="70%"><span class="gen"><input name="user_dl_auto_traffic" type="text" class="post" size="10" maxlength="50" value="{USER_DL_AUTO_TRAFFIC}" />&nbsp;
				...
				<input name="data_user_range" type="radio" value="GB" {USER_DATA_RANGE_GB} />&nbsp;{L_DL_GB}</span></td>
		</tr>
		<!-- BEGIN group_block -->
		<tr>
			<th class="thCornerL"><b>{L_GROUP_NAME}</b></th>
			<th class="thCornerR" width="75%"><b>{L_GROUP_DL_AUTO_TRAFFIC}</b></th>
		</tr>
		<!-- END group_block -->
		<!-- BEGIN group_row -->
		<tr>
			<td class="row1" width="30%"><span class="gen">{group_row.GROUP_NAME}</span></td>
			<td class="row2" width="70%"><span class="gen"><input name="group_dl_auto_traffic[{group_row.GROUP_ID}]" type="text" class="post" size="10" maxlength="50" value="{group_row.GROUP_DL_AUTO_TRAFFIC}" />&nbsp;
