...
<tr>
	<th class="thHead" colspan="3">{L_DL_FILES_TITLE}</th>
</tr>
<tr>
	<td class="row3" colspan="3" align="center"><span class="gensmall">{L_DL_FILES_TEXT}</span></td>
</tr>
</table>
<br />
...
<tr>
	...
	<th class="thTop" nowrap="nowrap" colspan="3">{L_DL_NAME} / {L_DL_FILE_NAME}</th>
	<th class="thTop" nowrap="nowrap">{L_DL_FILE_SIZE}</th>
	<th class="thTop" nowrap="nowrap">{L_DL_IS_FREE}</th>
	<th class="thTop" nowrap="nowrap">{L_DL_EXTERN}</th>
	<th class="thTop" nowrap="nowrap">{L_DL_FILE_KLICKS}<br />{L_DL_FILE_OVERALL_KLICKS}</th>
	<th class="thTop" nowrap="nowrap">{L_DL_FILE_TRAFFIC}</th>
	<th class="thTop">{L_DL_HACKLIST}</th>
...
<tr>
	...
	<td class="{downloads.ROW_CLASS}" align="center"><span class="gensmall">
