...
<tr>
	...
	<td class="row2" width="68%"><input type="radio" name="file_free" value="0" {CHECKNOTFREE} />&nbsp;{L_NO}
					<input type="radio" name="file_free" value="1" {CHECKFREE} />&nbsp;{L_YES}
					<input type="radio" name="file_free" value="2" {CHECKFREE_REG} />&nbsp;{L_FREE_REG}</td>
</tr>
<tr>
	...
	<td class="row2" width="68%"><input type="text" class="post" name="file_traffic" size="10" maxlength="10" value="{TRAFFIC}" />
					...
					<input name="file_traffic_range" type="radio" value="GB" {FILE_TRAFFIC_RANGE_GB} />&nbsp;{L_GB}</td>
</tr>
<tr>
