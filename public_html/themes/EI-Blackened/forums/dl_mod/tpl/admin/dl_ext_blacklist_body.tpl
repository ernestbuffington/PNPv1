...
<tr>
	<th class="thHead" colspan="2">{L_DL_EXT_BLACKLIST}</th>
</tr>
<tr>
...
<table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
<tr>
	<th width="50%" class="thCornerL">{L_DL_EXTENTIONS}</th>
	<th width="50%" class="thCornerR"><input type="submit" name="submit" class="mainoption" value="{L_DL_DEL_EXTENTIONS}" /></th>
</tr>
<!-- BEGIN extention_row -->
<tr>
...
<tr>
	...
	<td class="catbottom" align="center"><input type="submit" name="submit" class="mainoption" value="{L_DL_DEL_EXTENTIONS}" /></td>
</tr>
</table>
