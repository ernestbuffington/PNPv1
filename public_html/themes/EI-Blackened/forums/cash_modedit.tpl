...
<form action="{S_MODEDIT_ACTION}" method="post"><table cellspacing="2" cellpadding="2" border="0" align="center" class="forumline">
	...
	<tr>
	  <td width="30%" class="row22" align="center"><b><span class="gen">{L_AMOUNT}</span></b></td>
	  ...
	  <td class="row1">
		<table cellspacing="2" cellpadding="2" border="0" align="center">
			...
			<tr>
			  ...
			  <td class="row2" align="center"><span class="gen">{cashrow.RECEI-BlackenedVER_AMOUNT}</span></td>
