...
<table width="100%" cellspacing="1" cellpadding="6" border="0" align="center" class="forumline">
  <tr>
  <td width="50%" colspan="2" class="row1"><span class="genmed">{rep_stats.L_TOTALRECEI-BlackenedVED}:</span></td>
...
<table width="100%" border="0" cellspacing="4" cellpadding="4">
  <tr>
  <td width="150" class="row1"><span class="gensmall">{rep_stats.L_RECEI-BlackenedVEDREPUTATION}</span></td>
