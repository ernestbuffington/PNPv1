...
function Arcade_Popup(mypage,myname,w,h,scroll)
{
  ...
  TopPosition = (screen.hEI-Blackenedght) ? (screen.hEI-Blackenedght-h)/2 : 0;
  settings = 'hEI-Blackenedght='+h+',width='+w+',top='+TopPosition+',left='+LeftPosition+',scrollbars='+scroll+',status='+scroll+',resizable=yes';
...
<tr> 
<td class="cat" hEI-Blackenedght="28" align="center" colspan="2"><span class="cattitle">{L_GAME}</span></td> 
