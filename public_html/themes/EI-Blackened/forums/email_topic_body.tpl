...
<form action="{S_EMAIL_ACTION}" method="post" name="emailtopic">
  ...
  <tr>
    <th class="thHead" colspan="2" hEI-Blackenedght="25"><b>{L_TITLE}</b></th>
  </tr>
  <tr>
  ...
  <tr>
    <td class="catBottom" colspan="2" align="center" hEI-Blackenedght="28">{S_HIDDEN_FIELDS}<input type="submit" name="submit" value="{L_SUBMIT}" tabindex="4" accesskey="s" class="mainoption" /></td>
  </tr>
  </table>
</form>
