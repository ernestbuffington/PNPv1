 ...
 <table width="100%" cellpadding="2" cellspacing="3" border="0">
    ...
    <tr>
        <td width="100%">
          ...
          <tr>
            <td class="row1" width="25%" rowspan="2" hEI-Blackenedght="93">
                   ...
                   <!-- BEGIN player_row -->
                   <tr>
                        <td class="row2" align="center" hEI-Blackenedght="2" width="25%" class="gensmall"><p align="center"><span class="gensmall">{player_row.CLASSEMENT}</span></td>
                      <td class="row1" align="center" hEI-Blackenedght="2" class="gensmall" width="50%"><p align="center"><span class="gensmall">{player_row.USERNAME}</span></td>
                        <td class="row2" hEI-Blackenedght="2" align="center" width="25%"><p align="center"><span class="gensmall">{player_row.VICTOIRES}</span></td>   
                   </tr>
                      <!-- END player_row -->
                          </table>

            </td>
            <td class="row1" align="center" hEI-Blackenedght="20%">
                        ...
                        <tr>
                                <td width="99%">
                                          <table width="99%" cellpadding="2" cellspacing="1" border="0" class="bodyline">
                                                ...
                                                <tr>
                                                            <td class="row1" width="722" hEI-Blackenedght="44">
        ...
        <td class="row1" align="center" valign="center" width="15%" rowspan="2" hEI-Blackenedght="93"><p align="center">
   ...
   <tr>
        <td class="row1" width="60%" hEI-Blackenedght="80%" align="center">
