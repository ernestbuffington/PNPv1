...
<table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
  <tr>
  <!-- BEGIN cashtable -->
	<td hEI-Blackenedght="100%" valign="top" class="row1">
	<table width="100%" hEI-Blackenedght="100%" cellspacing="2" cellpadding="2" border="0" align="center" class="forumline">
	  <tr>
	  ...
	  <tr>
		...
		<!-- BEGIN exchangEI-Blackenedtem -->
			{rowrow.cashtable.switch_exon.exchangEI-Blackenedtem.EXCHANGE}<br />
		<!-- END exchangEI-Blackenedtem -->
	    </span></td>
	  </tr>
	  <!-- END switch_exon -->
	  <!-- BEGIN switch_exoff -->
