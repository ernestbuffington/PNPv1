...
<form method="post" action="{S_POST_DAYS_ACTION}">
  <table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
    ...
    <tr> 
      <td align="left"><a href="{U_POST_NEW_TOPIC}"><img src="{POST_IMG}" border="0" alt="{L_POST_NEW_TOPIC}" /></a>
...
<td class="row1" width="100%"  onmouseover="this.style.backgroundColor='#5a5aec'" onmouseout="this.style.backgroundColor='#3333b7'" onclick="window.location.href='{topicrow.U_VIEW_TOPIC}'"><span class="topictitle">{topicrow.NEWEST_POST_IMG}{topicrow.TOPIC_ATTACHMENT_IMG}{topicrow.TOPIC_TYPE}<a href="{topicrow.U_VIEW_TOPIC}" class="topictitle">{topicrow.TOPIC_TITLE}</a></span><span class="gensmall"><br />
  ...
  <table width="100%" cellspacing="2" border="0" align="center" cellpadding="2">
    ...
    <td align="left" >
      ...
      <table><tr><td class="nav">{PAGINATION}</td></tr>
      </table> 
        </td>
    </tr>
    <tr>
