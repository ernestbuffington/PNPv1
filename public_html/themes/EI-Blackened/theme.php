...
/*=======================================================================
 ...
 =======================================================================*/
/*****************************************************************************************/
/* EI-Blackened Theme v.1.0                                                              */
/* Designed By: Fury Designs - www.t3clans.com   			                             */
/* ===================================================================================== */
/* EI-Blackened Theme v.1.0 is a public theme package designed for PHP-Nuke Evolution    */
// Copyright © 2005 by Fury Designs - www.t3clans.com All Rights Reserved                */
/*****************************************************************************************/
...
if (file_exists(NUKE_THEMES_DIR.$theme_name.'/css/style2.php')):
  addPHPCSSToHead(theme_phpstyle_dir.'style2.php','file');   
  echo "\n<!-- THEME FLYKIT IS ENABLED Now Loading themes/".$theme_name."/css/style2.php in themes/".$theme_name."/theme.php (PHP FlyKit v2.1 Mod) -->\n";
else:
  addCSSToHead(theme_style_dir.'style2.css','file');
endif;
...
function OpenTable() {
    ...
    echo "      <tr>\n";
    echo "        <td width=\"37\" height=\"36\"><img src=\"themes/EI-Blackened/images/ttl.jpg\" alt=\"\" width=\"37\" height=\"36\" /></td>\n";
    echo "        <td style=\"background-image: url(themes/EI-Blackened/images/tt.jpg)\"><img src=\"themes/EI-Blackened/images/spacer.gif\" alt=\"\" width=\"1\" height=\"1\" /></td>\n";
    echo "        <td width=\"37\" height=\"36\"><img src=\"themes/EI-Blackened/images/ttr.jpg\" alt=\"\" width=\"37\" height=\"36\" /></td>\n";
    echo "      </tr>\n";
    echo "    </table>\n";
    echo "      <table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\n";
    echo "        <tr>\n";
    echo "          <td width=\"37\" style=\"background-image: url(themes/EI-Blackened/images/tl.jpg)\"><img src=\"themes/EI-Blackened/images/spacer.gif\" alt=\"\" width=\"1\" height=\"1\" /></td>\n";
...
function CloseTable() {
    echo "</td>\n";
    echo "          <td width=\"37\" style=\"background-image: url(themes/EI-Blackened/images/tr.jpg)\"><img src=\"themes/EI-Blackened/images/spacer.gif\" alt=\"\" width=\"1\" height=\"1\" /></td>\n";
    echo "        </tr>\n";
    echo "      </table>\n";
    echo "      <table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\n";
    echo "        <tr>\n";
    echo "          <td width=\"37\" height=\"36\"><img src=\"themes/EI-Blackened/images/tbl.jpg\" alt=\"\" width=\"37\" height=\"36\" /></td>\n";
    echo "          <td style=\"background-image: url(themes/EI-Blackened/images/tb.jpg)\"><img src=\"themes/EI-Blackened/images/spacer.gif\" alt=\"\" width=\"1\" height=\"1\" /></td>\n";
    echo "          <td width=\"37\"><img src=\"themes/EI-Blackened/images/tbr.jpg\" alt=\"\" width=\"37\" height=\"36\" /></td>\n";
    echo "        </tr>\n";
    echo "      </table>\n";
    echo "  </td>\n";
    echo "  </tr>\n";
...
/************************************************************/
function themeheader() {
    global $user, $cookie, $prefix, $user_prefix, $db, $dbi, $userinfo, $flash, $searchbox, $ip, $name, $banners, $theme_name, $ThemeInfo;
   ...
   echo "<body topmargin=\"0\" leftmargin=\"0\" marginwidth=\"0\" marginheight=\"0\">";
    ...
    echo "        <tr valign=\"top\">\n";
    echo "        <td style=\"width: 57px; background-image: url(themes/EI-Blackened/images/left.jpg)\" valign=\"top\"><img src=\"themes/".$theme_name."/images/spacer.gif\" width=\"57\" height=\"13\" border=\"0\" alt=\"\" /></td>\n";
    echo "        <td valign=\"top\">\n";
...
while ($row = $db->sql_fetchrow($result)) {
   ...
   // $content .= "<strong><big>&middot;</big></strong>&nbsp;$a: <a href=\"modules.php?name=Downloads&amp;d_op=viewdownloaddetails&amp;lid=$row[lid]&amp;title=$row[title]\">$title2</a><br />";
	if(!isset($content))
	$content = '';
	$content .= "<strong><big>&middot;</big></strong>&nbsp;<a href=\"modules.php?name=Downloads&amp;d_op=viewdownloaddetails&amp;lid=$row[lid]&amp;title=$row[title]\"><img src=\"themes/EI-Blackened/images/spacer.gif\" border=0></a> $a: <a href=\"modules.php?name=Downloads&amp;d_op=viewdownloaddetails&amp;lid=$row[lid]&amp;title=$row[title]\">$title2</a></span><br />";
	 $showdl = " <font class=copyright>&nbsp;</b><br />&nbsp;<A name= \"scrollingCode\"></A><MARQUEE behavior= \"scroll\" align= \"left\" direction= \"up\" width=\"160\" height=\"91\" scrollamount= \"2\" scrolldelay= \"30\" onmouseover='this.stop()' onmouseout='this.start()'>$content";
...
if(blocks_visible('right') && !defined('ADMIN_FILE')) {
    ...
    echo "</td>\n";
    echo "<td style=\"width: 57px; background-image: url(themes/EI-Blackened/images/right.jpg)\" valign=\"top\"><img src=\"themes/".$theme_name."/images/spacer.gif\" alt=\"\" width=\"57\" height=\"13\" /></td>\n";
    echo "        </tr>\n";
    echo "</table>\n\n\n";
