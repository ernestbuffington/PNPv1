...
global $board_config;
$footerdate = FormatDate($board_config['default_dateformat'], time(), $board_config['board_timezone']);
echo '<td valign="top"><span style="font-size: 85%; color: silver;"><br>'.$footerdate.'<br>PHP-Nuke Platinum v'.NUKE_PLATINUM.'<br>Apache 2.4 & PHP v'.PHPVERS.'</span></td>';
echo '<td></td>';
echo '</tr>';
echo '<tr>';
