...
#-----------------------------------------------------------------------------#
# Theme Copyright System Settings and Informatiom for the current Theme START #
#-----------------------------------------------------------------------------#
...
$theme_business = 'DESTINE DESIGNS';                     // Copyright Business
$theme_title = '<u>Mech Theme v1.0 &copy; 2023</u>';     // Theme name
$theme_overview = 'BOOTSTRAP 3.4.1 / HTML4.01 / XML';    // Theme Overview
$theme_markup_lang = 'HTML 4.01 Transitional';           // Markup Lang
$theme_author = 'ZoNE, Vision, and Mustang';             // Authors(s) (Leave Blank if you are the Port Author) 
$theme_ported_by = 'Ernest Allen Buffington';            // Who Ported the Theme (Leave Blank if you are the Author)
$theme_date = '01/01/2004';                              // Theme Date
...
echo '<!-- Copyright System Modal START -->'."\n";
...
echo '</div>'."\n";
echo '</div>'."\n";
echo '<!-- Copyright System Modal END -->'."\n";
