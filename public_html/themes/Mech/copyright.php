...
echo '<br /><i class="bi bi-arrow-right-square-fill"></i> Copyright: <i class="far fa-copyright"></i> DESTINE DESIGNS'."\n";
echo '<br /><i class="bi bi-arrow-right-square-fill"></i> Creation Date: '.THEME_DATE.''."\n";
echo '<br /><i class="bi bi-arrow-right-square-fill"></i> Authors: '.THEME_AUTHOR.''."\n";
