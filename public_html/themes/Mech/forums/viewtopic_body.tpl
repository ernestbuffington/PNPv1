...
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0">
  ...
  <tr>
   <td><img name="tlc" src="themes/Mech/images/tlc.gif" width="20" height="25" border="0" alt=""></td> 
   <td width="100%" background="themes/Mech/images/tm.gif"><img name="tm" src="themes/Mech/images/spacer.gif" width="1" height="1" border="0" alt=""></td>
   <td><img name="trc" src="themes/Mech/images/trc.gif" width="20" height="25" border="0" alt=""></td>
  </tr>
  <tr>
    <td background="themes/Mech/images/leftside.gif"><img name="leftside" src="themes/Mech/images/spacer.gif" width="1" height="1" border="0" alt=""></td>
     <td valign="top" bgcolor="#212224">
    ...
    <td background="themes/Mech/images/rightside.gif"><img name="rightside" src="themes/Mech/images/spacer.gif" width="1" height="1" border="0" alt=""></td>
  </tr>
  <tr>
   <td><img name="blc" src="themes/Mech/images/blc.gif" width="20" height="25" border="0" alt=""></td>
   
    <td background="themes/Mech/images/tbm.gif"><img name="tbm" src="themes/Mech/images/spacer.gif" width="1" height="1" border="0" alt=""></td>
   <td><img name="brc" src="themes/Mech/images/brc.gif" width="20" height="25" border="0" alt=""></td>
  </tr></table>
	...
	<tr> 
		<td class="spaceRow" colspan="2" height="1"><img src="themes/Mech/forums/images/spacer.gif" alt="" width="1" height="1" /></td>
	</tr>
	<!-- END postrow -->
	<tr align="center"> 
