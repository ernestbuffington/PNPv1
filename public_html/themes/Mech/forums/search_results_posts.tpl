...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline" align="center">
  ...
  <tr> 
	...
	<td class="catHead" colspan="2" height="28"><span class="topictitle"><img src="themes/Mech/forums/images/folder.gif" align="absmiddle">  {L_TOPIC}: <a href="{searchresults.U_TOPIC}" class="topictitle">{searchresults.TOPIC_TITLE}</a></span></td>
