		  ...
		  <td colspan="3" width="100%" class="row2">
			...
			<table cellspacing="0" cellpadding="1" border="0">
			  ...
			  <tr> 
				...
				<td bgcolor="{T_TD_COLOR2}"><img src="themes/Mech/forums/images/spacer.gif" width="{INBOX_LIMIT_IMG_WIDTH}" height="8" alt="{INBOX_LIMIT_PERCENT}" /></td>
...
<table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
  ...
  <table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	...
	<tr> 
	  ...
	  {listrow.PRIVMSG_ATTACHMENTS_IMG}<td width="55%" valign="middle" class="{listrow.ROW_CLASS}"><span class="topictitle"> <a href="{listrow.U_READ}" class="topictitle">{listrow.SUBJECT}</a></span></td>
