...
define("_phpverfail", "You need at least PHP version 8.2 to Install PHP-Nuke Platinum.");
...
define("_step1fail", "You cannot proceed with the Installation of PHP-Nuke Platinum as your Server doesn't meet the Minimum System Requirements.");

define("_step1warn", "You can proceed with the Installation of PHP-Nuke Platinum, but you will not experience the Best Performance.");

// Step 2
define("_step2", "<strong>Step 2: License Agreement</strong>");

define("_gpllicense", "In order to Install PHP-Nuke Platinum you must Agree to ALL the Terms of the Apache License, under which PHP-Nuke Platinum is Released.");

define("_lgpllicense", "You must also Agree to ALL Terms of the GNU/LGPL License because PHP-Nuke Platinum uses Open Source Libraries Released under that License.");
...
define("_step3explain", "You can now Configure PHP-Nuke Platinum's Basic Settings.  These Settings include Database Access (i.e. username, password...) and some Advanced Settings like Cookie Encryption and the Mass Uploads Directory.  Further details below.");
...
define("_cannotwriteconfig", "Cannot Save the Configuration File.  Please Create a File named <strong>configdata.php</strong> in the <strong>/include</strong> directory of PHP-Nuke Platinum and Paste the following code in it (ALL of it -- if you Copy & Pasted correctly, the file starts with <strong><?php</strong> and ends with <strong>?></strong>)");

define("_step3complete", "Configuration Completed.  You can now Install the PHP-Nuke Platinum Database.");
...
define("_admpcookiepathexplain", "Cookie Path.  Change this Setting <strong>ONLY</strong> if PHP-Nuke Platinum is Installed in a <strong>Sub-Directory</strong> on your Server.  If your Installation is in <strong>http://yoursite.com/an602</strong>, the Setting should be <strong>/an602</strong>");
...
define("_admpstealthmodeexplain", "This will Disable and Hide the Local Tracker.  PHP-Nuke Platinum will ONLY Accept Externally Tracked Torrents.");
...
define("_step7explain", "Congratulations!  PHP-Nuke Platinum has now been Installed and Configured.  Now you can start using your Brand New Tracker and Start Sharing Files!  Before starting, keep in mind the following:-");

define("_thingstodo", "<ul>\n
<li><p>Please Delete the <em>setup</em> Directory!  For Security Reasons, PHP-Nuke Platinum will NOT work until the Directory is Deleted.</p></li>\n
...
<li><p>If you like PHP-Nuke Platinum, why don't you consider making a Small <strong>Donation</strong> to those who wrote it in order to help keep the Project Alive and Updated?</p></li>\n
</ul>\n");

define("_thanks", "Thank you for choosing this fantastic Open Source Software.  Regards, The PHP-Nuke Platinum Group!");
define("_enter", "Enter PHP-Nuke Platinum");
