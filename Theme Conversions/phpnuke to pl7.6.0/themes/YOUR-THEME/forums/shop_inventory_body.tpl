...
<br>
  ...
  <table width="99%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
	<tr>
		<td width="100%" align="center" class="row1"><br><span class="gensmall">Shop Modification 2.5.0: Copyright © 2003, <a href="http://www.knightsofchaos.com/zarath/mods/" class="navsmall">Zarath Technologies</a>.</span><br><br></td>
	</tr>
  </table>
<br	clear="all" />
